...
const Sidebar = () => {
  return (
    <header className="fixed top-0 left-0 bottom-0 w-[300px] transition-all duration-500 ease-in-out z-[9997] px-[15px] bg-[#040b14] overflow-y-auto">
      <div className="flex flex-col items-center">
        <div className="profile mt-4 text-center">
          ...
          <div className="social-links mt-3 flex justify-center gap-3 text-white text-xl">
